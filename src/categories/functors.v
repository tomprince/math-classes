...
Implicit Arguments object [[A][Arrows0] [H] [CatId0] [CatComp0][B] [Arrows1] [H1] [CatId1] [CatComp1] [Fmap_inst][Functor_inst]] [[A][Arrows0] [H] [CatId0] [CatComp0] [B] [Arrows1] [H1] [CatId1] [CatComp1][Functor_inst]].
